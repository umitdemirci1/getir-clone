...
const AnimatedFragment = () => {
    ...
    return (
        <div>
            <div className="relative h-[500px] before:bg-gradient-to-r before:from-slider-gradient-primary-color before:to-transparent before:absolute before:inset-0  before:w-full before:h-full before:z-10">
                <Slider {...settings}>
                    <div>
                ...
                <div className="container flex justify-between items-center absolute top-0 left-1/2 -translate-x-1/2 h-full z-20">
                    <div>
                        ...
                        <p className="text-white mt-8 text-4xl font-semibold">Dakikalar içinde <br></br>kapınızda</p>
                    </div>
                    <div className="w-[400px] rounded-lg bg-gray-50 p-6">
                        <h4 className="text-slider-gradient-primary-color text-center font-semibold">Giriş yap veya kayıt ol</h4>
                        <div className="grid gap-y-4">
                                ...
                                <label className="flex-1 relative group">
                                    <input required type="text"
                                        ...
                                        border-gray-300 rounded 
                                         transition-colors group-hover:border-slider-gradient-primary-color
                                         outline-none focus:border-slider-gradient-primary-color
                                         peer"/>
                                    <span className="absolute top-0 left-0 px-4 flex items-center 
                                    mt-[18px] ml-[2px] text-sm text-gray-500 
                                    peer-focus:mt-1 peer-focus:text-xs peer-focus:text-slider-gradient-primary-color transition-all
                                    peer-valid:mt-1 peer-valid:text-xs peer-valid:text-slider-gradient-primary-color
                                    cursor-text 
                                     ">
                            ...
                            bg-yellow-button-color rounded-lg p-4
                             text-slider-gradient-primary-color
                            hover:bg-slider-gradient-primary-color
